...
- **`MCP_Server`** (`includes/class-mcp-server.php`) — JSON-RPC 2.0 dispatcher. Handles `initialize`, `tools/list`, `tools/call`, and `ping` methods. Protocol version: `2025-11-25` (Streamable HTTP).
